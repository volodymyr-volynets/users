...
$provider = new Facebook([
    'clientId'     => \Application::get('oauth.provider.FACEBOOK.client_id'),
    'clientSecret' => \Application::get('oauth.provider.FACEBOOK.secret'),
    'redirectUri'  => \Request::host() . ltrim(\Application::get('oauth.provider.FACEBOOK.redirect_url'), '/'),
