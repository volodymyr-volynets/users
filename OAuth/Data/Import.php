...
class Import extends \Object\Import
{
    public $data = [
        'modules' => [
            ...
            'data' => [
                [
                    'sm_module_code' => 'OA',
                    'sm_module_type' => 20,
                    'sm_module_name' => 'O/A OAuth',
                    'sm_module_abbreviation' => 'O/A',
        ...
        'features' => [
            ...
            'data' => [
                [
                    'sm_feature_module_code' => 'OA',
                    'sm_feature_code' => 'OA::OAUTH',
                    'sm_feature_type' => 10,
                    'sm_feature_name' => 'O/A OAuth',
                    'sm_feature_icon' => 'fa-regular fa-user',
