...
class Promocodes extends \Object\Form\Wrapper\List2 {
	...
	public $elements = [
		...
		'filter' => [
			'am_promocode_id' => [
				'am_promocode_id1' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Promocode #', 'domain' => 'group_id', 'percent' => 25, 'null' => true, 'query_builder' => 'a.am_promocode_id;>='],
				'am_promocode_id2' => ['order' => 2, 'label_name' => 'Promocode #', 'domain' => 'group_id', 'percent' => 25, 'null' => true, 'query_builder' => 'a.am_promocode_id;<='],
		...
		self::LIST_CONTAINER => [
			'row1' => [
				'am_promocode_id' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Promocode #', 'domain' => 'group_id', 'percent' => 10, 'url_edit' => true],
