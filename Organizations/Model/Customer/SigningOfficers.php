...
class SigningOfficers extends Table
{
    public $db_link;
    public $db_link_flag;
    ...
    public $columns = [
        ...
        'on_custsignofficer_custsigntype_code' => ['name' => 'Signing Type', 'domain' => 'type_code', 'options_model' => SigningTypes::class],
