...
class OrganizationFakeNames extends Collection
{
    public $data = [
        'name' => 'Organizations',
        ...
        'details' => [
            ...
            '\Numbers\Users\Organizations\Model\Organizations\0Virtual0\Widgets\Addresses' => [
                'name' => 'Addresses',
                'pk' => ['wg_address_tenant_id', 'wg_address_organization_id', 'wg_address_type_code'],
                'type' => '1M',
                'map' => ['on_organization_tenant_id' => 'wg_address_tenant_id', 'on_organization_id' => 'wg_address_organization_id'],
            ]
        ]
    ];
}
