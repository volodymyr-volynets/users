...
class LocationsWithAddress extends \Object\DataSource {
	public $db_link;
	public $db_link_flag;
	...
	public function query($parameters, $options = []) {
		...
		$this->query->join('LEFT', new \Numbers\Countries\Countries\Model\Provinces(), 'c2', 'ON', [
		...
		$this->query->join('LEFT', new \Numbers\Countries\Countries\Model\Countries(), 'c3', 'ON', [
