...
use Numbers\Users\Organizations\Model\Organization\Type\Map;
use Object\Form\Wrapper\List2;

class Organizations extends List2
{
    public $form_link = 'on_organizations_list';
    public $module_code = 'ON';
    public $title = 'O/N Organizations List';
    public $options = [
