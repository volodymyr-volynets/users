...
class Customers extends \Object\Form\Wrapper\List2 {
	...
	public $elements = [
		...
		'filter' => [
			...
			'on_customer_organization_id' => [
				'on_customer_organization_id1' => \Numbers\Users\Organizations\Helper\Filter::F_ORGANIZATION_ID + ['row_order' => 200, 'query_builder' => 'a.on_customer_organization_id;=']
			],
			'full_text_search' => [
