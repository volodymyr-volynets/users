...
class Categories extends \Object\Form\Wrapper\List2 {
	...
	public $elements = [
		...
		'filter' => [
			'on_servcategory_id' => [
				'on_servcategory_id1' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Category #', 'domain' => 'group_id', 'percent' => 25, 'null' => true, 'query_builder' => 'a.on_servcategory_id;>='],
				'on_servcategory_id2' => ['order' => 2, 'label_name' => 'Category #', 'domain' => 'group_id', 'percent' => 25, 'null' => true, 'query_builder' => 'a.on_servcategory_id;<='],
		...
		self::LIST_CONTAINER => [
			'row1' => [
				'on_servcategory_id' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Category #', 'domain' => 'group_id', 'percent' => 10, 'url_edit' => true],
