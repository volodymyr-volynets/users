...
class NewCheckOut extends Base
{
...
TTT;
    ...
    public function validate(& $form)
    {
        ...
        $form->values['wg_checkin_duration'] = Date::diff($form->values['wg_checkin_checkin_timestamp'], $form->values['wg_checkin_checkout_timestamp'], 'abs seconds', true);
        // custom method
