...
class NewTag extends \Object\Form\Wrapper\Base {
	...
	public function validate(& $form) {
		if (empty($form->values['wg_tag_name']) && empty($form->values['wg_tag_global_tag_id'])) {
			$form->error(DANGER, \Object\Content\Messages::REQUIRED_FIELD, 'wg_tag_name');
			$form->error(DANGER, \Object\Content\Messages::REQUIRED_FIELD, 'wg_tag_global_tag_id');
			return;
		}
