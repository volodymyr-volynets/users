...
use Numbers\Users\Widgets\Comments\Model\Templates;
use Object\Content\Messages;
use Object\Form\Wrapper\Base;

class NewComment extends Base
{
    ...
    public $elements = [
        'top' => [
            ...
            'wg_comment_template_id' => [
                'wg_comment_template_id' => ['order' => 1, 'row_order' => 150, 'label_name' => 'Template', 'domain' => 'group_id', 'null' => true, 'percent' => 50, 'placeholder' => Messages::PLEASE_CHOOSE, 'method' => 'select', 'options_model' => '\Numbers\Users\Widgets\Comments\Model\Templates::optionsActive', 'options_params' => ['um_notetemplate_type_id' => 100], 'onchange' => 'this.form.submit();'],
