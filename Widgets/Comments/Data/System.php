...
class System extends Import
{
    public $data = [
        'controllers' => [
            ...
            'data' => [
                [
                    'sm_resource_id' => '::id::\Numbers\Users\Widgets\Comments\Controller\Templates',
                    'sm_resource_code' => '\Numbers\Users\Widgets\Comments\Controller\Templates',
                    'sm_resource_type' => 100,
                    'sm_resource_classification' => 'Settings',
                    'sm_resource_name' => 'U/M Comment Templates',
                    'sm_resource_description' => null,
                    'sm_resource_icon' => 'fa-solid fa-thumbtack',
        ...
        'menu' => [
            ...
            'data' => [
                [
                    'sm_resource_id' => '::id::\Menu\Numbers\Users\Widgets\Comments\Controller\Templates',
                    'sm_resource_code' => '\Menu\Numbers\Users\Widgets\Comments\Controller\Templates',
                    'sm_resource_type' => 200,
                    'sm_resource_name' => 'Comment Templates',
                    'sm_resource_description' => null,
                    'sm_resource_icon' => 'fa-solid fa-thumbtack',
                    'sm_resource_module_code' => 'UM',
                    'sm_resource_group1_name' => 'Operations',
                    ...
                    'sm_resource_acl_permission' => 1,
                    'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Users\Widgets\Comments\Controller\Templates',
                    'sm_resource_menu_acl_method_code' => 'Index',
                    'sm_resource_menu_acl_action_id' => '::id::List_View',
                    'sm_resource_menu_url' => '/Numbers/Users/Widgets/Comments/Controller/Templates',
                    'sm_resource_menu_options_generator' => null,
                    'sm_resource_inactive' => 0
                ],
            ]
