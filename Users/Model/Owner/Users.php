...
class Users extends \Object\Table {
	...
	public $pk = ['um_owneruser_tenant_id', 'um_owneruser_type_id', 'um_owneruser_user_id', 'um_owneruser_linked_type_code', 'um_owneruser_linked_module_id', 'um_owneruser_linked_id'];
	public $tenant = true;
	public $orderby;
	public $limit;
	...
	public $constraints = [
		'um_owner_users_pk' => ['type' => 'pk', 'columns' => ['um_owneruser_tenant_id', 'um_owneruser_type_id', 'um_owneruser_user_id', 'um_owneruser_linked_type_code', 'um_owneruser_linked_module_id', 'um_owneruser_linked_id']],
