...
class LoginsAR extends ActiveRecord
{
    /**
     * @var string
     */
    public string $object_table_class = Logins::class;
     ...
     * @var int|null Type: boolean
     */
    public int|null $um_usrlogin_mfa_triggered = 0 {
        get => $this->um_usrlogin_mfa_triggered;
        set {
            $this->setFullPkAndFilledColumn('um_usrlogin_mfa_triggered', $value);
            $this->um_usrlogin_mfa_triggered = $value;
        }
    }
