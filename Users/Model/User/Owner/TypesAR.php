...
class TypesAR extends ActiveRecord
{
     ...
     */
    public int|null $um_ownertype_weight = null {
        get => $this->um_ownertype_weight;
        set {
            $this->setFullPkAndFilledColumn('um_ownertype_weight', $value);
            $this->um_ownertype_weight = $value;
        }
    }
