...
class Accounts extends \Object\Table {
	...
	public $pk = ['um_usrlinked_tenant_id', 'um_usrlinked_user_id', 'um_usrlinked_linked_id'];
	public $tenant = true;
	public $orderby = [
	...
	public $constraints = [
		'um_user_linked_accounts_pk' => ['type' => 'pk', 'columns' => ['um_usrlinked_tenant_id', 'um_usrlinked_user_id', 'um_usrlinked_linked_id']],
