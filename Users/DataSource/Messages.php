...
class Messages extends DataSource
{
    ...
    public function query($parameters, $options = [])
    {
        ...
        $this->query->columns([
            ...
            'to_phone' => 'a.um_mesrecip_user_phone',
        ...
        if (!empty($parameters['chat_by_group'])) {
            $this->query->join('INNER', function (& $query) use ($parameters) {
                $query = Recipients::queryBuilderStatic(['alias' => 'inner_a'])->select();
                $query->columns([
