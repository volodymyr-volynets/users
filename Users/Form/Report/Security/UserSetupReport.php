...
class UserSetupReport extends \Object\Form\Wrapper\Report {
	...
	public function buildReport(& $form) {
		...
		// join permissions
		$query->join('LEFT', function (& $query) {
			$query = \Numbers\Users\Users\Model\User\Permission\Actions::queryBuilderStatic(['alias' => 'inner_a'])->select();
			$query->columns([
			...
			$query->join('INNER', new \Numbers\Users\Users\Model\User\Permissions(), 'inner_b', 'ON', [
		...
		// join notifications
		$query->join('LEFT', function (& $query) {
			$query = \Numbers\Users\Users\Model\User\Notifications::queryBuilderStatic(['alias' => 'inner_a'])->select();
			$query->columns([
		...
		// join subresources
		$query->join('LEFT', function (& $query) {
			$query = \Numbers\Users\Users\Model\User\Permission\Subresources::queryBuilderStatic(['alias' => 'inner_a'])->select();
			$query->columns([
		...
		// join features
		$query->join('LEFT', function (& $query) {
			$query = \Numbers\Users\Users\Model\User\Features::queryBuilderStatic(['alias' => 'inner_a'])->select();
			$query->columns([
		...
		$query->join('LEFT', function (& $query) {
			...
			// join
			$query->join('INNER', new \Numbers\Users\Users\Model\Teams(), 'inner_b', 'ON', [
		...
		$roles = \Numbers\Users\Users\Model\Roles::optionsStatic(['i18n' => true, 'skip_acl' => true]);
		$teams = \Numbers\Users\Users\Model\Teams::optionsStatic(['i18n' => true, 'skip_acl' => true]);
