    ...
    public $elements = [
        ...
        'login_container' => [
            ...
            'um_user_login_last_set' => [
                ...
                'um_user_login_password_new' => ['order' => 2, 'label_name' => 'Reset Password', 'domain' => 'password', 'method' => 'password', 'percent' => 50, 'required' => false, 'empty_value' => true, 'skip_during_export' => true, 'autocomplete' => 'new-password']
            ]
        ],
        'security_answers_container' => [
            'row1' => [
