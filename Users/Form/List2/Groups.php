    ...
    public $elements = [
        ...
        self::LIST_CONTAINER => [
            'row1' => [
                ...
                'um_usrgrp_name' => ['order' => 2, 'label_name' => 'Name', 'domain' => 'name', 'percent' => 55],
                'um_usrgrp_code' => ['order' => 3, 'label_name' => 'Code', 'domain' => 'group_code', 'percent' => 30],
                'um_usrgrp_inactive' => ['order' => 4, 'label_name' => 'Inactive', 'type' => 'boolean', 'percent' => 5]
            ]
        ]
    ];
