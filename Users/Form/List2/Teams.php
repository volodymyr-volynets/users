...
class Teams extends \Object\Form\Wrapper\List2 {
	...
	public $elements = [
		...
		'filter' => [
			'um_team_id' => [
				'um_team_id1' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Team #', 'domain' => 'group_id', 'percent' => 25, 'null' => true, 'query_builder' => 'a.um_team_id;>='],
				'um_team_id2' => ['order' => 2, 'label_name' => 'Team #', 'domain' => 'group_id', 'percent' => 25, 'null' => true, 'query_builder' => 'a.um_team_id;<='],
		...
		self::LIST_CONTAINER => [
			'row1' => [
				'um_team_id' => ['order' => 1, 'row_order' => 100, 'label_name' => 'Team #', 'domain' => 'group_id', 'percent' => 10, 'url_edit' => true],
