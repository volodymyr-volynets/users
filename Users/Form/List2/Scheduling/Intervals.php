	...
	public $elements = [
		...
		self::LIST_CONTAINER => [
			...
			'row2' => [
				...
				'um_schedinterval_user_id' => ['order' => 2, 'label_name' => 'User', 'domain' => 'user_id', 'null' => true, 'percent' => 25],
				'um_schedinterval_organization_id' => ['order' => 3, 'label_name' => 'Organization', 'domain' => 'organization_id', 'null' => true, 'percent' => 25],
				'um_schedinterval_location_id' => ['order' => 4, 'label_name' => 'Location', 'domain' => 'location_id', 'null' => true, 'percent' => 20],
				'um_schedinterval_work_start_timestamp' => ['order' => 5, 'label_name' => 'Work Start', 'type' => 'timestamp', 'percent' => 10],
				'um_schedinterval_work_finish_timestamp' => ['order' => 6, 'label_name' => 'Work Finish', 'type' => 'timestamp', 'percent' => 10],
			]
		]
	];
