...
class Step3 extends Base
{
    ...
    public $elements = [
        'default' => [
            'separator_2' => [
                self::SEPARATOR_HORIZONTAL => ['order' => 1, 'row_order' => 50, 'label_name' => 'Set Administrator\'s Password', 'icon' => 'fa-solid fa-user', 'percent' => 100],
            ],
    ...
    public function save(& $form)
    {
        ...
        do {
            ...
            $organization_result = Organizations::collectionStatic()->merge([
            ...
            $crypt = new \Crypt();
            $user_result = Users::collectionStatic()->merge([
                'um_user_code' => null,
                'um_user_type_id' => 10,
            ...
            $assignment_result = \Numbers\Users\Users\Model\User\Roles::collectionStatic()->merge([
                ...
                'um_usrrol_role_id' => Roles::getByColumnStatic('um_role_code', 'SA', 'um_role_id')
            ]);
            if (!$assignment_result['success']) {
                $form->error('danger', $error_message);
                break;
            ...
            foreach (['SM', 'AN', 'TM', 'ON', 'CM', 'IN', 'UM'] as $v) {
                $module_activation_result = Activation::activateModule($v, null);
