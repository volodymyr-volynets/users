...
class Step1 extends Base
{
    ...
    public $title = 'U/M Registration Tenant Step1 Form';
    public $options = [
        'segment' => [
            'type' => 'primary',
            'header' => [
    ...
    public $elements = [
        'default' => [
            ...
            'separator_1' => [
                self::SEPARATOR_HORIZONTAL => ['order' => 1, 'row_order' => 300, 'label_name' => 'Organization', 'icon' => 'fa-solid fa-sitemap', 'percent' => 100],
            ],
            ...
            'separator_2' => [
                self::SEPARATOR_HORIZONTAL => ['order' => 1, 'row_order' => 500, 'label_name' => 'Administrator', 'icon' => 'fa-solid fa-user', 'percent' => 100],
            ],
    ...
    public function validate(& $form)
    {
        if (!empty($form->values['um_regten_tenant_code'])) {
            $tenant_result = Tenants::getStatic([
                'where' => [
    ...
    public function save(& $form)
    {
        ...
        if (!$result['success']) {
            ...
            // send email message
            $crypt = new \Crypt();
            $mail_result = Sender::notifySingleUser('UM::EMAIL_TENANT_CONFIRMATION', 0, $form->values['um_regten_user_email'], [
                'replace' => [
                    'body' => [
