...
class GrantOrganizations extends \Object\Form\Wrapper\Base {
	...
	public function validate(& $form) {
		...
		$users = \Numbers\Users\Users\DataSource\Users::getStatic([
			'where' => [
		...
		$organization_model = new \Numbers\Users\Users\Model\User\Organizations();
		$organization_model->db_object->begin();
		$new_insert = [];
		$existing_organizations = \Numbers\Users\Users\Model\User\Organizations::getStatic([
			'where' => [
