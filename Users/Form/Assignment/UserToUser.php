...
class UserToUser extends Base
{
    ...
    public function validate(& $form)
    {
        ...
        if (empty($data['um_assignusrtype_multiple'])) {
            $other_users = Assignments::getStatic([
                'where' => [
            ...
            if (!empty($other_users)) {
                $form->error(DANGER, Messages::ASSIGNMENT_EXISTS, 'um_usrassign_parent_user_id');
            }
        }
    }
}
