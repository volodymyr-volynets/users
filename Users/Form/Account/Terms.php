...
{
    public $form_link = 'um_account_terms';
    public $module_code = 'UM';
    public $title = 'U/M Account Terms Form';
    public $options = [
    ...
    public $containers = [
        ...
        'signatures_container' => [
            ...
            'details_new_rows' => 1,
            'details_key' => '\Numbers\Users\Users\Model\User\Terms',
            'details_pk' => ['um_usrterm_id'],
            'order' => 35000
        ],
    ];
    public $rows = [
    ...
    public $elements = [
        ...
        'signatures_container' => [
            'um_usrterm_name' => [
                'um_usrterm_name' => ['order' => 1, 'row_order' => 200, 'label_name' => 'Name', 'domain' => 'name', 'null' => true, 'percent' => 50, 'required' => true],
                'um_usrterm_module_code' => ['order' => 2, 'label_name' => 'Module', 'domain' => 'module_code', 'null' => true, 'required' => true, 'percent' => 45, 'method' => 'select', 'options_model' => '\Numbers\Backend\System\Modules\Model\Modules::optionsActive', 'onchange' => 'this.form.submit();'],
            ...
            self::HIDDEN => [
                'um_usrterm_id' => ['label_name' => 'Signature #', 'domain' => 'bigterm_id_sequence', 'null' => true, 'method' => 'hidden'],
            ]
        ],
        'buttons' => [
    ...
    public $collection = [
        ...
        'details' => [
            '\Numbers\Users\Users\Model\User\Terms' => [
                'name' => 'UM User Terms',
                'pk' => ['um_usrterm_tenant_id', 'um_usrterm_user_id', 'um_usrterm_id'],
                'type' => '1M',
                'map' => ['um_user_tenant_id' => 'um_usrterm_tenant_id', 'um_user_id' => 'um_usrterm_user_id']
            ],
        ]
    ];
