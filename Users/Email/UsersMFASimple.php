...
class UsersMFASimple extends Email
{
    public $form_link = 'um_users_mfs_simple_email';
    public $module_code = 'UM';
    public $title = 'U/M Users MFA Simple Email';
    public $options = [
        'segment' => [
            'type' => 'primary',
        ],
    ...
    public $rows = [
        'top_panel' => [
            'center' => ['order' => 100, 'label_name' => 'Multi Factor Authentication', 'loc' => 'NF.Form.MultiFactorAuthentication', 'panel_type' => 'primary', 'percent' => 100]
        ],
    ];
    public $elements = [
        'top_panel' => [
    ...
    {
        return nl2br2($form->values['message']);
    }
}
