...
class UserSignIns extends DashboardAbstract2
{
    public $dashboard_code = 'UM::USER_SIGNIN_DASHBOARD';
    ...
    public function render(array $options = []): array
    {
        ...
        $result = \SQL2::queryStatic(null, '/Numbers/Users/Users/SQL/Dashboards/UserSignIns.' . $db_object->backend . '.object.sql', null, [
            'tenant_id' => \Tenant::id(),
        ...
        $html = \HTML::chartjs([
            'type' => 'line',
            'labels' => array_column($result['rows'], 'date2'),
            'datasets' => [
                [
                    'label' => '# of Logins',
