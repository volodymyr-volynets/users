...
class System extends \Object\Import {
	public $data = [
		'controllers' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Numbers\Users\APIs\Controller\Users',
					'sm_resource_code' => '\Numbers\Users\APIs\Controller\Users',
					'sm_resource_type' => 100,
					'sm_resource_classification' => 'Settings',
					'sm_resource_name' => 'U/A API Users',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fas fa-users',
					'sm_resource_module_code' => 'UA',
		...
		'menu' => [
			...
			'data' => [
				[
					'sm_resource_id' => '::id::\Menu\Operations\UserManagement\APIs',
					'sm_resource_code' => '\Menu\Operations\UserManagement\APIs',
					'sm_resource_type' => 299,
					'sm_resource_name' => 'APIs',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fab fa-bity',
					'sm_resource_module_code' => 'UA',
					'sm_resource_group1_name' => 'Operations',
					'sm_resource_group2_name' => 'User Management',
					...
					'sm_resource_inactive' => 0
								...
								[
					'sm_resource_id' => '::id::\Menu\Numbers\Users\APIs\Controller\Users',
					'sm_resource_code' => '\Menu\Numbers\Users\APIs\Controller\Users',
					'sm_resource_type' => 200,
					'sm_resource_name' => 'API Users',
					'sm_resource_description' => null,
					'sm_resource_icon' => 'fas fa-users',
					'sm_resource_module_code' => 'UA',
					'sm_resource_group1_name' => 'Operations',
					...
					'sm_resource_acl_permission' => 1,
					'sm_resource_menu_acl_resource_id' => '::id::\Numbers\Users\APIs\Controller\Users',
					'sm_resource_menu_acl_method_code' => 'Index',
					'sm_resource_menu_acl_action_id' => '::id::List_View',
					'sm_resource_menu_url' => '/Numbers/Users/APIs/Controller/Users',
					'sm_resource_menu_options_generator' => null,
					'sm_resource_inactive' => 0
				]
			]
