...
class ResourceView extends \Object\Form\Wrapper\Base {
	...
	public function renderAPIs(& $form) {
		...
		$name = i18n(null, $name);
		$methods = \Object\Reflection::getMethods($method_object, \ReflectionMethod::IS_PUBLIC, \Route::HTTP_REQUEST_METHOD_LOWER_CASE);
		$table = [
