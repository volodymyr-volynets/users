...
class Import extends \Object\Import
{
    public $data = [
        'modules' => [
            ...
            'data' => [
                [
                    'sm_module_code' => 'D9',
                    'sm_module_type' => 20,
                    'sm_module_name' => 'D/9 Dashboards',
                    'sm_module_abbreviation' => 'D/9',
                    'sm_module_icon' => 'fa-solid fa-clone',
        ...
        'features' => [
            ...
            'data' => [
                [
                    'sm_feature_module_code' => 'D9',
                    'sm_feature_code' => 'D9::DASHBOARDS',
                    'sm_feature_type' => 10,
                    'sm_feature_name' => 'D/9 Dashboards',
                    'sm_feature_icon' => 'fa-solid fa-clone',
