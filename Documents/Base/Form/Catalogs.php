    ...
    public $elements = [
        'top' => [
            ...
            'dt_catalog_storage_id' => [
                'dt_catalog_dt_amzprofile_id' => ['order' => 1, 'row_order' => 300, 'label_name' => 'Amazon Profile', 'domain' => 'profile_id', 'null' => true, 'persistent' => 'if_set', 'method' => 'select', 'options_model' => Profiles::class, 'description' => 'Empty stores files on a server file system.'],
